...
namespace Fungus.Commands.UVariable
{
    [CommandInfo("UVariable", "Set UVariable", "Set data into UVariable")]
    public class SetUVariable : Command
    {
        [SerializeField] protected UVariableSystem.UVariable holder;
        ...
        public override void OnEnter()
        {
            ...
            if (variableType == typeof(BooleanVariable))
            {
                ...
                if (booleanVariable != null)
                {
                    ...
                    holder.SetValue(UVariableType.Bool, booleanVariable.Value);
                }
            }
            else if (variableType == typeof(IntegerVariable))
            {
                ...
                {
                    holder.SetValue(UVariableType.Int, integerVariable.Value);
                }
            }
            else if (variableType == typeof(FloatVariable))
            {
                ...
                {
                    holder.SetValue(UVariableType.Float, floatVariable.Value);
                }
            }
            else if (variableType == typeof(StringVariable))
            {
                ...
                {
                    holder.SetValue(UVariableType.String, stringVariable.Value);
                }
            }
